...
@interface CNCodeNumberLayoutManager ()
...
@implementation CNCodeNumberLayoutManager
    ...
    [self enumerateLineFragmentsForGlyphRange:glyphsToShow
                                   usingBlock:^(CGRect rect, CGRect usedRect, NSTextContainer *textContainer, NSRange glyphRange, BOOL *stop) {
                                       ...
                                       if (charRange.location == paraRange.location) {
                                           gutterRect = CGRectOffset(CGRectMake(0, rect.origin.y, self.width, rect.size.height), origin.x, origin.y);
                                           ...
                                           switch (self.codeNumberAlignment) {
                                               case CNCodeNumberAlignmentLeft:
                                                   [ln drawInRect:CGRectOffset(gutterRect, 4, (CGRectGetHeight(gutterRect) - size.height) / 2.0)
                                                   withAttributes:atts];
                                                   break;
                                               case CNCodeNumberAlignmentRight:
                                                   [ln drawInRect:CGRectOffset(gutterRect, CGRectGetWidth(gutterRect) - 4 - size.width, (CGRectGetHeight(gutterRect) - size.height) / 2.0)
                                                   withAttributes:atts];
                                                   break;
                                               case CNCodeNumberAlignmentCenter:
                                                   [ln drawInRect:CGRectOffset(gutterRect, (CGRectGetWidth(gutterRect) - size.width)/2, (CGRectGetHeight(gutterRect) - size.height) / 2.0)
                                                   withAttributes:atts];
                                                   break;
                                               default:
                                                   [ln drawInRect:CGRectOffset(gutterRect, CGRectGetWidth(gutterRect) - 4 - size.width, (CGRectGetHeight(gutterRect) - size.height) / 2.0)
